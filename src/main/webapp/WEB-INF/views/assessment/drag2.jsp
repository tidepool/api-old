		...
		(function ($) {
			$(document).ready(function () {	
		      ...
		      function drawImages() {		            
		          ...
		          layer.add(build5Circle("Dedicated/ \nLoyal", "dedicated_loyal", 410, 350));
		          layer.add(build5Circle("Resilent/ \nSurvivor", "resilent_survivor", 565, 350));
		          layer.add(build5Circle("Well-versed/ \nBrilliant", "well-versed_brilliant", 725, 350));		          
		          stage.add(layer);
		        }
