  ...
  <body>
    ...
    <div class="container">
		<table class="table">
			...
			<c:forEach  var="codedItem" items="${codedItems}" varStatus="trainingSetCounter">
				<tr>
				 	<td>${ codedItem.id }</td><td><img class="imageViewer"  src="${cdn_url}/${codedItem.bucket_name}/${codedItem.folder_name}/${codedItem.picture_id}"></td>
				</tr>						
			</c:forEach>
		</table>
