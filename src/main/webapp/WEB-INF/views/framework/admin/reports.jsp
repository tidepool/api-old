	    	    ...
	    	    <div class="row-fluid mini-layout">
	  				<div class="span10 mini-layout-breadcrumbs">
	  					<ul class="breadcrumb">
  							...
  							<li class="active"><a href="#">Reports</a> <span class="divider">/</span></li>  							
						</ul>
	  				</div>
	  			</div>
	  			<div class="row-fluid mini-layout">  				
	    			<div class="span2 mini-layout-sidebar">
	    				...
	    				<c:forEach var="report" items="${reports}" varStatus="rowCounter">
							  ...
							  <div class="accordion-group">
							    ...
							    <div id="collapseOne" class="accordion-body collapse">
							      <div class="accordion-inner">
							        <a href="<c:url value="/report${ report.id }" />">Detail</a>
							      </div>
							    </div>
							  </div>
	    			...
	    			<div class="span7 mini-layout-body">
	      				<a href="report" class="btn btn-primary">Create New Report</a>
	    			</div>
	  			</div>
			</div>
		</div>
